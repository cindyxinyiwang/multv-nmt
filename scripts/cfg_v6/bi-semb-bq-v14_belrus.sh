...
python3.6 src/main.py \
  ...
  --ordered_char_dict \
  --train_shuffle \
  --output_dir="outputs_v6/bi-semb-bq-v14_belrus/" \
  ...
  --src_char_vocab_from  data/bel_eng/ted-train.mtok.bel.ochar4vocab,data/rus_eng/ted-train.mtok.rus.ochar4vocab \
  --src_char_vocab_size='-1,-1' \
  --trg_char_vocab_from  data/belrus_eng/ted-train.mtok.spm8000.eng.ochar4vocab \
